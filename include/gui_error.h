...
#define  RULE_USER_CHAIN_NOT_EXIST	24
#define  RULE_PKTMETA_IFNAME_INVALID	25
#define  RULE_PKTMETA_IIFNAME_INVALID	26
#define  RULE_PKTMETA_OIFNAME_INVALID	27
#define  RULE_ERROR_NUM			28
